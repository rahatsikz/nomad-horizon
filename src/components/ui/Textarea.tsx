      ...
      <Controller
        ...
        render={({ field }) => (
          <textarea
            ...
            value={field.value ?? ""}
            className='w-full bg-transparent text-secondary rounded border dark:border-neutral px-4 py-2 text-sm outline-none transition-all autofill:bg-transparent focus:border-primary focus:outline-none resize-none'
            autoComplete='off'
            rows={rows}
          ></textarea>
        )}
